 ...
 */
package com.luxpmsoft.luxaipoc.common.helpers;
...
public final class CameraPermissionHelper {
  ...
  public static void requestCameraPermission(Activity activity) {
    ActivityCompat.requestPermissions(
        activity, new String[] {CAMERA_PERMISSION, WRITE_EXTERNAL_STORAGE, READ_EXTERNAL_STORAGE,
            ACCESS_COARSE_LOCATION, ACCESS_FINE_LOCATION}, CAMERA_PERMISSION_CODE);
  }
